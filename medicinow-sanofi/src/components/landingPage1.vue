<template>
  <div class="home">
    ...
    <div id="about_us" >
      ...
      <p class="about-us-text">Fundada em 2019, a MediciNow veio com a missão de desburocratizar o agendamento e organização de consultas médicas, com foco em uma solução Web e Mobile.</p>
    </div>
